...
var messages=["Music Obsessive","Watching the same few shows fanatic","Automation Diehard"];
var rank=0;
...
function changeTxt(e){
  ...
  _h1.style.webkitAnimation = 'none'; // set element animation to none
   setTimeout(function() { // you surely want a delay before the next message appears
      ...
      var speed =1.5*messages[rank].length/23.5; // adjust the speed (3.5 is the original speed, 20 is the original string length
